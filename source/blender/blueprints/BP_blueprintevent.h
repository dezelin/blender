...
#ifndef __BP_BLUEPRINTEVENT_H__
#define __BP_BLUEPRINTEVENT_H__

typedef struct BP_BlueprintEvent {
	struct BP_BlueprintEvent *next, *prev;
	void *ctx;
} BP_BlueprintEvent;
