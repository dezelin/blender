...
#ifndef __BP_BLUEPRINTFUNC_H__
#define __BP_BLUEPRINTFUNC_H__

typedef struct BP_BlueprintFunc {
	struct BP_BlueprintFunc *next, *prev;
	void *ctx;
} BP_BlueprintFunc;
